...
* The original package name 'com.example..referandom' is invalid and this project uses 'com.example.referandom' instead.
...
* [JDBC API](https://docs.spring.io/spring-boot/docs/3.1.1-SNAPSHOT/reference/htmlsingle/#data.sql)
